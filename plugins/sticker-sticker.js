...
if (/video/g.test(mime)) if ((q.msg || q).seconds > 10) return m.reply('*⚠️ EL VÍDEO NO PUEDE DURAR MAS DE 10 SEGUNDOS*')
...
console.log('*⚠️ RESPONDE A UNA IMAGEN O UN VIDEO PARA CONVERTIRLO EN STICKER*')
console.log(stiker)
}}
